...
def main():
    ...
    for fill_type in ["zero","mean","mice"]:
        ...
        for fold_n in index.keys():
            ...
            ppca = PPCA()
            ppca.fit(data=X_train_imputed, d=100)
            component_mat_train = ppca.transform(X_train_imputed)
            component_mat_test = ppca.transform(X_test_imputed)
    ...
    csv_file_name = "results/{}/{}/{}/{}_{}.csv".format("PPCA", dataname, types, para, full_norm)
